...
i<-1
write(paste(ms," ",as.character(nchr)," ",as.character(nloci)," -t ",as.character(tn1[i])," -r ",as.character(srec[i])," ",as.character(ll)," -I ",as.character(deme[i])," ",as.character(nchr)," ",paste(rep("0",(deme[i]-1)),collapse=" ")," ",as.character(m[i])," | ",cpd,"compute_pd.py -np 1 -nc ",nchr," -w 100 -b 20 > ",out,".tab",sep=""),stderr())
for (i in 1:nsims){
	print(i)
	if (i==1){
		system(paste(ms," ",as.character(nchr)," ",as.character(nloci)," -t ",as.character(tn1[i])," -r ",as.character(srec[i])," ",as.character(ll)," -I ",as.character(deme[i])," ",as.character(nchr)," ",paste(rep("0",(deme[i]-1)),collapse=" ")," ",as.character(m[i])," | ",cpd,"compute_pd.py -np 1 -nc ",nchr," -w 100 -b 20 > ",out,".tab",sep=""))
	}
	else{
		system(paste(ms," ",as.character(nchr)," ",as.character(nloci)," -t ",as.character(tn1[i])," -r ",as.character(srec[i])," ",as.character(ll)," -I ",as.character(deme[i])," ",as.character(nchr)," ",paste(rep("0",(deme[i]-1)),collapse=" ")," ",as.character(m[i])," | ",cpd,"compute_pd.py -np 1 -nc ",nchr," -w 100 -b 20 >> ",out,".tab",sep=""))
	}
