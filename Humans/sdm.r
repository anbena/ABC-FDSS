#./ms 12 2 -t 0.4 -I 10 0 2 0 2 0 2 0 2 2 2 -n 6 5 -n 7 5 -n 8 5 -n 9 5 -n 10 5 -m 6 7 1.52 -m 7 6 8.66 -m 7 8 3.07 -m 8 7 3.76 -m 8 9 0.28 -m 9 8 0.22 -m 9 10 0.51 -m 10 9 0.52 -es 0.25 5 0.998 -ej 0.2501 11 9 -es 0.37 3 0.96 -ej 0.3701 12 10 -es 0.39 1 0.998 -ej 0.3901 13 10 -ej 0.43 9 8 -en 0.4301 8 4 -em 0.4301 7 8 5.73 -em 0.4301 8 7 5.01 -em 0.4301 8 10 5.05 -em 0.432 10 8 7.42 -es 0.44 5 0.989 -ej 0.4401 14 8 -en 0.46 8 0.125 -en 0.46 10 0.125 -ej 0.49 8 7 -ej 0.49 10 7 -es 0.51 5 0.977 -ej 0.5101 15 7 -ej 0.94 5 4 -en 1.05 7 0.125 -ej 1.077 7 6 -ej 3.38 3 2 -ej 4.26 4 2 -ej 5 2 1 -ej 5.5 6 1
...
#Rscript --vanilla ./ooa_m1.r <nchr> <locuslength> <nlociXsim> <recrate=1.12e-8> <nsimulations>
...
tGbot<-(tdYG-tbot)
#tdOA<-sample(35000:tGbot,nsims,replace=T)
...
for (i in 1:nsims){
	...
	if (i==1){
		if (staNEA[i] >= staARP[i] ){
			...
			#print("tre")
			#write(li3,stderr())
			system(paste(li3," | ",cpd,"compute_pd.py -np 6 -nc ",nchr," -w 30 -b 50 -s > ",out,".tab",sep=""))
		}else if (staNEA[i] < staDP[i]) {
			#print("due")
			#write(li2,stderr())
			system(paste(li2," | ",cpd,"compute_pd.py -np 6 -nc ",nchr," -w 30 -b 50 -s > ",out,".tab",sep=""))
		}
	}else{
		if (staNEA[i] >= staARP[i] ){
			#print("uno")
